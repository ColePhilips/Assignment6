...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "http://localhost:8000/" //This will be changed to the web application URL so when the user is done authenticating this will be there endpoint, will also need to be updated on google site
  },
